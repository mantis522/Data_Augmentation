...
# 이 모델 테스트 최대 정확도? : 0.8832
loss, acc = model_hepler.model.evaluate(x_test, y_test, verbose=1)
print("Restored model, accuracy: {:5.2f}%".format(100 * acc))


## https://github.com/zdqzyx/NLP/blob/master/TextClassification/imp_by_tensorflow2/TextSelfAtt/main.py