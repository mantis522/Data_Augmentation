...
# class BERT_NLP(Model):
#     def __init__(self,
#                  maxlen,
#                  class_num,
#                  last_activation='softmax'):
#         super(BERT_NLP, self).__init__()
#         self.maxlen = maxlen
...
#         input_masks = Input(shape=(self.maxlen,), dtype=tf.int32, name="input_masks")
#         input_segments = Input(shape=(self.maxlen,), dtype=tf.int32, name="segment_ids")
#
