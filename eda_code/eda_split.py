...
csv_file = r"D:\ruin\data\amazon\amazon_review_polarity_csv\amazon_bart_with_huggingface_sentiment.csv"
...
while start < 50000:
    ...
    train_f = open("D:/ruin/data/eda_nlp/amazon/train/" +'train' + str(end) + '.txt', 'w', encoding='utf-8')
    for i in range(len(train_text)):
        data = str(train_label[i]) + '\t' + train_text[i] + '\n'
        train_f.write(data)
    train_f.close()

    test_f = open("D:/ruin/data/eda_nlp/amazon/test/" +'test' + str(plus) + '.txt', 'w', encoding='utf-8')
