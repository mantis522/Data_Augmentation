...
train_labels = train_df['label'].to_numpy().flatten()
...
test_labels = test_df['label'].to_numpy().flatten()

valid_text = val_df['text'].to_numpy()
...
valid_labels = val_df['label'].to_numpy().flatten()
